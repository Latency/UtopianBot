...
public class Summoning extends MethodProvider {
  ...
  public static enum Familiar {
    ...
    Familiar(final String name, final int requiredLevel, final int time, final int sp, final String scrollName, final int space) {
      this.name = name;
   ...
   */
  public int getLevel() {
    return methods.skills.getRealLevel(Skill.SUMMONING);
  }
  ...
  public boolean doAttack() {
    return methods.interfaces.getComponent(INTERFACE_TAB_SUMMONING, INTERFACE_TAB_SUMMONING_CHILD).interact(om.Server.toString("sumAttack"));
  }
  ...
  public boolean doCast() {
    return isFamiliarSummoned() && methods.inventory.getItemID(getFamiliar().getScrollName()) != -1
        && methods.interfaces.getComponent(INTERFACE_TAB_SUMMONING, INTERFACE_TAB_SUMMONING_CHILD).interact(om.Server.toString("sumCast"));
  }
  ...
  public boolean doCancel() {
    return methods.interfaces.getComponent(INTERFACE_TAB_SUMMONING, INTERFACE_TAB_SUMMONING_CHILD).interact(om.Server.toString("sumCancel"));
  }
  ...
  public boolean doRenewFamiliar() {
    return isFamiliarSummoned() && methods.inventory.getItemID(getFamiliar().getName() + " " + om.Server.toString("sumPouch")) != -1 &&
        methods.interfaces.getComponent(INTERFACE_TAB_SUMMONING, INTERFACE_TAB_SUMMONING_CHILD).interact(om.Server.toString("sumRenewFamiliar"));
  }
  ...
  public boolean doTakeBob() {
    return methods.interfaces.getComponent(INTERFACE_TAB_SUMMONING, INTERFACE_TAB_SUMMONING_CHILD).interact(om.Server.toString("sumTakeBoB"));
  }
  ...
  public boolean doDismiss() {
    ...
    if (dismissInterface != null && dismissInterface.interact(om.Server.toString("sumDismiss"))) {
  ...
  public boolean doCallFollower() {
    return methods.interfaces.getComponent(INTERFACE_TAB_SUMMONING, INTERFACE_TAB_SUMMONING_CHILD).interact(om.Server.toString("sumCallFollower"));
  }
  ...
  public boolean doShowDetails() {
    return methods.interfaces.getComponent(INTERFACE_TAB_SUMMONING, INTERFACE_TAB_SUMMONING_CHILD).interact(om.Server.toString("sumFollowerDetails"));
  }
  ...
  public boolean setLeftClickOption(final int option) {
    methods.interfaces.getComponent(INTERFACE_TAB_SUMMONING, INTERFACE_TAB_SUMMONING_CHILD).interact(om.Server.toString("sumSelectOption"));
  ...
  public Familiar getFamiliar() {
    for (final int element : methods.client.getRSNPCIndexArray()) {
      final Node node = Nodes.lookup(methods.client.getRSNPCNC(), element);
