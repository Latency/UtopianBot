...
public class Players extends MethodProvider {
  ...
  /**
   * Returns the <tt>RSPlayer</tt> that is nearest, out of all of the Players accepted by the provided filter.
   * 
   * @param filter
   *          Filters unwanted matches.
   * @return An <tt>RSPlayer</tt> object representing the nearest player that was accepted by the provided Filter; or null if there are no matching players in the current region.
   */
  ...
  /**
   * Returns the <tt>RSPlayer</tt> that is nearest, out of all of the Players with the provided name.
   * 
   * @param name
   *          The name of the <tt>RSPlayer</tt> that you are searching for.
   * @return An <tt>RSPlayer</tt> object representing the nearest player with the provided name; or null if there are no matching players in the current region.
   */
  ...
  /**
   * Returns the <tt>RSPlayer</tt> that is nearest, out of all of the Players with the provided combat level.
   * 
   * @param level
   *          The combat level of the <tt>RSPlayer</tt> that you are searching for.
   * @return An <tt>RSPlayer</tt> object representing the nearest player with the provided combat level; or null if there are no matching players in the current region.
   */
