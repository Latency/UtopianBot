...
public class Menu extends MethodProvider {
  ...
  public Menu(final MethodContext ctx) {
    super(ctx);
  }

  /**
   * Clicks the menu option. Will left-click if the menu item is the first, otherwise open menu and click the option.
   * 
  ...
  /**
   * Checks whether or not a given action (or action substring) is present in the menu.
   * 
  ...
  /**
   * Checks whether or not a given action with given option is present in the menu.
   * 
   * @param action The action or action substring.
  ...
  /**
   * Returns an array of the first parts of each item in the current menu context.
   * 
   ...
   * @param option The option of the menu entry of which you want the index. If option is null, operates like getIndex(String action).
   * @return The index of the given option in the context menu; otherwise -1.
   */
  ...
  public String[] getItems() {
    String[] options = getOptions(), actions = getActions();
    ...
    if (output.size() > 1 && output.get(0).equals(om.Server.toString("menuCancel"))) {
  ...
  /**
   * Returns an array of the second parts of each item in the current menu context.
   * 
