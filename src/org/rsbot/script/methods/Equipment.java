...
public class Equipment extends MethodProvider {
   ...
   * 
   * @param itemID
   *          The item ID to count. Same as the equipment/item id in the inventory.
   ...
   * 
   * @param items
   *          The item ID to check for. Same as the equipment/item id in the inventory.
   ...
   * @return <tt>true</tt> if the player has one (or more) of the given items equipped; otherwise <tt>false</tt>.
   */
