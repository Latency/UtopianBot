...
public class Tiles extends MethodProvider {
  public Tiles(final MethodContext ctx) {
    super(ctx);
  }
   ...
   * @param action The action to perform at the given <code>RSTile</code>.
   * @return <tt>true</tt> if no exceptions were thrown; otherwise <tt>false</tt>.
   * @see script.methods.Tiles#interact(script.wrappers.RSTile, double, double, int, String)
   */
   ...
   * @param option The option to perform at the given <code>RSTile</code>.
   * @return <tt>true</tt> if no exceptions were thrown; otherwise <tt>false</tt>.
   * @see script.methods.Tiles#interact(script.wrappers.RSTile, double, double, int, String, String)
   */


  /**
   * Clicks a tile if it is on screen. It will left-click if the action is available as the default option, otherwise it will right-click and check for the action in the context
   * methods.menu.
   * 
   ...
   * @param action Action command to use click
   * @return <tt>true</tt> if the tile was clicked; otherwise <tt>false</tt>.
   * @see script.methods.Tiles#interact(script.wrappers.RSTile, String)
   */


  /**
   * Clicks a tile if it is on screen. It will left-click if the action is available as the default menu action, otherwise it will right-click and check for the action in the
   * context methods.menu.
   * 
   * @param tile The RSTile that you want to click.
   ...
   * @param option Option of the menu entry to click
   * @return <tt>true</tt> if the tile was clicked; otherwise <tt>false</tt>.
   * @see script.methods.Tiles#interact(script.wrappers.RSTile, String, String)
   */
   ...
   * 
   * @return The <code>RSTile</code> under the mouse, or null if the mouse is not over the viewport.
   */
   ...
   * @return True if the first tile is closer to the player than the second tile, otherwise false.
   */
