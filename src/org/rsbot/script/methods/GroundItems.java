...
public class GroundItems extends MethodProvider {
   ...
   * @return The nearest RSGroundItem with an ID that matches any in the array of IDs provided; or null if no matching ground items were found.
   */
   ...
   * @return The nearest RSGroundItem with a name that matches any in the array provided; or null if no matching ground items were found.
   */
  ...
  public RSGroundItem[] getAllAt(final int x, final int y) {
    ...
    final org.rsbot.client.NodeListCache itemNLC = (org.rsbot.client.NodeListCache) Nodes.lookup(itemNC, id);
