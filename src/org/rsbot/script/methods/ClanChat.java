...
public class ClanChat extends MethodProvider {
  ...
  public ClanChat(final MethodContext ctx) {
    super(ctx);
  }
  
  public class ClanUser extends FriendChat.User {
    public ClanUser(final String name, final RSComponent rank, final RSComponent world) {
      super(om, name, rank, world);
    }
  }
  ...
  public boolean inChannel() {
    ...
    return methods.game.getTab() == Game.Tab.CLAN_CHAT && methods.interfaces.getComponent(INTERFACE_CLAN_CHAT, INTERFACE_CLAN_CHAT_CHECK).containsText(om.Server.toString("If you"));
  }
