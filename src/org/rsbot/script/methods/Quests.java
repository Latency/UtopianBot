...
public class Quests extends MethodProvider {
  ...
  public int getPoints() {
    openTab();
    String s = methods.interfaces.getComponent(QUESTS, POINTS_COMPONENT).getText().replace(om.Server.toString("questQuestPoints") + ": ", "");
  ...
  /**
   * Returns a Quest.Progress object to reflect completion status of quest. Only works if not hidden.
   * 
   * @param name
