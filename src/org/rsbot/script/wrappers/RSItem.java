...
public class RSItem extends MethodProvider {
   ...
   * @return <tt>true</tt> if the component was clicked successfully; otherwise <tt>false</tt>.
   */
   ...
   * 
   * @param left <tt>true</tt> if the component should be left-click; <tt>false</tt> if it should be right-clicked.
   * @return <tt>true</tt> if the component was clicked successfully; otherwise <tt>false</tt>.
   */
  ...
  public RSItemDef getDefinition() {
    try {
      final org.rsbot.client.Node ref = Nodes.lookup(methods.client.getRSItemDefLoader(), id);
   ...
   * @return <tt>true</tt> if the item has the action; otherwise <tt>false</tt>.
   */
   ...
   * 
   * @return <tt>true</tt> if an item definition is available; otherwise <tt>false</tt>.
   */
