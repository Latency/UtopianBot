...
public class RSLocalPath extends RSPath {
  ...
  public boolean isValid() {
    return getNext() != null && !methods.players.getMyPlayer().getLocation().equals(end());
  }
   ...
   */
  public RSPath getCurrentTilePath() {
    return tilePath;
  }
  ...
  private static RSTile[] path(final Node end, final int base_x, final int base_y) {
