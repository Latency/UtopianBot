...
/**
 * Represents an interface component. An RSComponent may or may not have a parent component, and will always have a parent RSInterface.
 * 
 * @author Qauters
 */
public class RSComponent extends MethodProvider {
  /**
   * The index of this interface in the parent. If this component does not have a parent component, this represents the index in the parent interface; otherwise this represents the component index in the parent component.
   */
  ...
  /**
   * Returns the index of this interface in the parent. If this component does not have a parent component, this represents the index in the parent interface; otherwise this represents the component index in the parent component.
   * 
  ...
  /**
   * Gets the parent interface of this component. This component may be nested from its parent interface in parent components.
   * 
