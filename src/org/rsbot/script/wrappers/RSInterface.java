...
public class RSInterface extends MethodProvider implements Iterable<RSComponent> {
   ...
   * 
   * @return the exact location of the interface, return (-1, -1) if interface was null.
   */
  ...
  /**
   * Iterates over the children of the interface. Will never return null even if the underlying interface is null.
   */
  @Override
