...
final class Item {
  ...
  /**
   * Type of this constant pool item. A single class is used to represent all constant pool item types, in order to minimize the bytecode size of this package. The value of this
   * field is one of {@link ClassWriter#INT}, {@link ClassWriter#LONG}, {@link ClassWriter#FLOAT}, {@link ClassWriter#DOUBLE}, {@link ClassWriter#UTF8}, {@link ClassWriter#STR},
   * {@link ClassWriter#CLASS}, {@link ClassWriter#NAME_TYPE}, {@link ClassWriter#FIELD}, {@link ClassWriter#METH}, {@link ClassWriter#IMETH}.
   * <p/>
   * Special Item types are used for Items that are stored in the ClassWriter {@link ClassWriter#typeTable}, instead of the constant pool, in order to avoid clashes with normal
   * constant pool items in the ClassWriter constant pool's hash table. These special item types are {@link ClassWriter#TYPE_NORMAL}, {@link ClassWriter#TYPE_UNINIT} and
  ...
  /**
   * Indicates if the given item is equal to this one. <i>This method assumes that the two items have the same {@link #type}</i>.
   * 
