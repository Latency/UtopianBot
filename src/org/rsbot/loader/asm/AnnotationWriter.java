...
final class AnnotationWriter implements AnnotationVisitor {
  ...
  /**
   * The annotation values in bytecode form. This byte vector only contains the values themselves, i.e. the number of values must be stored as a unsigned short just before these
   * bytes.
   */
