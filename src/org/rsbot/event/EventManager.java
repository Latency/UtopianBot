...
public class EventManager implements Runnable {
   ...
   * 
   * @param wait <tt>true</tt> to wait for the kill event to be processed before returning; otherwise <tt>false</tt> to submit the kill event and return immediately.
   */
